# ═══════════════════════════════════════════════════════════════
# Llama.cpp Elite Orchestrator — GTX 1070 Pascal
# GUI Unificada: Modelo + Settings para GTX 1070 (8GB VRAM)
# ═══════════════════════════════════════════════════════════════
param(
    [switch]$Test
)
...
$RESULT_FILE = "$env:TEMP\llama_launch_1070.txt"
...
$form.Text = "Llama.cpp Elite Orchestrator - GTX 1070 (Pascal)"
$form.ClientSize = New-Object Drawing.Size(960, 860)
$form.StartPosition = "CenterScreen"
$form.BackColor = [Drawing.Color]::FromArgb(25, 25, 30) # Tono azulado sutil para Pascal
...
$txtPath.BackColor = [Drawing.Color]::FromArgb(45, 45, 55); $txtPath.ForeColor = [Drawing.Color]::Cyan; $form.Controls.Add($txtPath)

$btnBrowse = New-Object Windows.Forms.Button
$btnBrowse.Text = "FOLDER"; $btnBrowse.Location = New-Object Drawing.Point(860, 12); $btnBrowse.Size = New-Object Drawing.Size(80, 30); $btnBrowse.BackColor = [Drawing.Color]::FromArgb(60, 60, 75); $form.Controls.Add($btnBrowse)
...
$txtHermes.BackColor = [Drawing.Color]::FromArgb(45, 45, 55); $txtHermes.ForeColor = [Drawing.Color]::DeepSkyBlue; $form.Controls.Add($txtHermes)

$btnHermes = New-Object Windows.Forms.Button
$btnHermes.Text = "CONFIG"; $btnHermes.Location = New-Object Drawing.Point(860, 52); $btnHermes.Size = New-Object Drawing.Size(80, 30); $btnHermes.BackColor = [Drawing.Color]::FromArgb(60, 60, 75); $form.Controls.Add($btnHermes)
...
$txtS.BackColor = [Drawing.Color]::FromArgb(40, 40, 50); $txtS.ForeColor = [Drawing.Color]::White; $form.Controls.Add($txtS)
...
$dgv.BackgroundColor = [Drawing.Color]::FromArgb(30, 30, 38); $dgv.BorderStyle = "None"
$dgv.CellBorderStyle = "SingleHorizontal"; $dgv.GridColor = [Drawing.Color]::FromArgb(55, 55, 70)
$dgv.ColumnHeadersDefaultCellStyle.BackColor = [Drawing.Color]::FromArgb(45, 45, 60)
$dgv.ColumnHeadersDefaultCellStyle.ForeColor = [Drawing.Color]::Cyan
$dgv.ColumnHeadersDefaultCellStyle.Font = New-Object Drawing.Font("Segoe UI", 10, [Drawing.FontStyle]::Bold)
$dgv.EnableHeadersVisualStyles = $false
$dgv.DefaultCellStyle.BackColor = [Drawing.Color]::FromArgb(35, 35, 45)
$dgv.DefaultCellStyle.ForeColor = [Drawing.Color]::White
$dgv.DefaultCellStyle.SelectionBackColor = [Drawing.Color]::FromArgb(0, 150, 255)
...
# ── Panel de Settings (GTX 1070 Pascal Layout) ──
$pnl = New-Object Windows.Forms.GroupBox
$pnl.Text = "  Optimizacion de Inferencia Pascal GTX 1070 (8GB VRAM)  "
$pnl.ForeColor = [Drawing.Color]::Cyan
...
function New-Setting {
    ...
    $cb = New-Object Windows.Forms.ComboBox; $cb.Location = New-Object Drawing.Point($x, 55); $cb.Width = 200; $cb.DropDownStyle = "DropDownList"; $cb.BackColor = [Drawing.Color]::FromArgb(45, 45, 55); $cb.ForeColor = [Drawing.Color]::White; $cb.FlatStyle = "Flat"
    foreach ($i in $items) { $cb.Items.Add($i) | Out-Null }; $cb.SelectedIndex = $def; $pnl.Controls.Add($cb)
    $tipLbl = New-Object Windows.Forms.Label; $tipLbl.Text = $tip; $tipLbl.ForeColor = [Drawing.Color]::LightGray; $tipLbl.Location = New-Object Drawing.Point($x, 85); $tipLbl.Size = New-Object Drawing.Size(210, 80); $tipLbl.Font = New-Object Drawing.Font("Segoe UI", 8); $pnl.Controls.Add($tipLbl)
    return $cb
}

# Contextos optimizados y ampliados hasta 128K para Pascal
$cCtx = New-Setting "Contexto (Tokens)" 15 @("2048 (2K)", "4096 (4K)", "8192 (8K)", "16384 (16K)", "32768 (32K)", "65536 (65K)", "131072 (128K)") 1 "Contexto del KV Cache. Advertencia: Valores >16K consumen mucha VRAM de la 1070"
...
# ── Botón Lanzar (Cyan Design) ──
$btn = New-Object Windows.Forms.Button
$btn.Text = "LANZAR MOTOR CUDA GTX 1070"
$btn.Location = New-Object Drawing.Point(250, 715); $btn.Size = New-Object Drawing.Size(460, 80); $btn.Anchor = "Bottom"
$btn.BackColor = [Drawing.Color]::Cyan; $btn.ForeColor = [Drawing.Color]::Black; $btn.FlatStyle = "Flat"
...
if ($Test) {
    ...
    $line = "$($dgv.Rows[0].Cells[3].Value)|4096|99|1|Default|$HERMES_CFG|$lanStr"
    [System.IO.File]::WriteAllText($RESULT_FILE, $line)
    exit 0
}
